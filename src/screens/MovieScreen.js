...
import { ScrollView, StyleSheet, Text, View, Dimensions, Image, TouchableOpacity, Linking, FlatList, Share} from 'react-native';
    ...
    <ScrollView>
      ...
      <Text style={styles.castTitle}>Cast</Text>
        ...
        <FlatList 
          ...
          ListHeaderComponent={() => <ItemSeperator width={10}/>}
          ItemSeparatorComponent={() => <ItemSeperator width={10}/>}
          ListFooterComponent={() => <ItemSeperator width={10}/>}
          renderItem={({item}) => (
            <CastCard
